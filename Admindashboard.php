...
<div class="row">  
    ...
    -->
      <ul class="mainmenu">
        <li><a href="">Users</a>
          <ul class="submenu">
            <li><a href="edituser.php" target="resultframe"><small><i class="fas fa-user-edit pr-2"></i>Edit User information</small></a></li>
            <li><a href="deleteuser.php" target="resultframe"><small><i class="fas fa-user-times pr-2"></i>Delete Users</small></a></li>
            <li><a href="changepassword.php" target="resultframe"><small><i class="fas fa-key pr-2"></i>Change Admin Password</small></a></li>
          </ul>
        </li>
        <li><a href="">Stories</a>
          <ul class="submenu">
